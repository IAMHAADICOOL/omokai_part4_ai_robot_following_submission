> **Note:** This is a **vendored fork** of the original `tb3_multi_robot`
> (github.com/arshadlab/tb3_multi_robot, Apache 2.0, by Arshad Mehmood).
> For the changes made in this repository, see **`OMOKAI_CHANGES.md`**.
> The original project documentation follows unchanged.
